...
if uploaded_files:
    for uploaded_file in uploaded_files:
        ...
        label = "Tumor Detected" if raw_value > 0.5 else "No Tumor"
        confidence = raw_value if label == "Tumor Detected" else (1 - raw_value)
        ...
        if raw_value > 0.5:
            ...
            try:
                ...
                _, thresh = cv2.threshold(gray, 5, 255, 0)  # Lowered threshold for sensitivity
                ...
                if contours:
                    ...
                    st.write("No clear tumor region detected. Try adjusting image contrast.")
            except Exception as e:
